...
const generateGame = () => {
    ...
    const emojis = ['المؤمّل', 'المنصور', 'المخلّص', 'القائم', 'المنتظر', 'المهدي', 'الحجة', 'بقية الله']
...
function showAlert() {
    ...
    Swal.fire({
        title: 'إرشادات',
        text: 'خلف هذه البطاقات ألقاب للإمام المهدي(عج). عزيزتي عليك  أن تطابقي الألقاب المتكررة مع بعضها قبل المتسابق الثاني ',
